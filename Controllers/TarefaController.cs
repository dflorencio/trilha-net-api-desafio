...
namespace TrilhaApiDesafio.Controllers 
{
    ...
    public class TarefaController : ControllerBase
    {
        ...
        {
            var buscarRegistro = _context.Tarefas.Where(x =>x.Titulo == titulo);            
            return Ok(buscarRegistro);
        }
        ...
        { 
           var tarefa = _context.Tarefas.Where(x => x.Status == (EnumStatusTarefa)status);
           return Ok(tarefa);
